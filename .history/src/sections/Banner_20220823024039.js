    ...
    return(
        <section className="bg-gray-light h-auto pb-10 relative">
            ...
            <Container>
                ...
                <div className="flex mt-96 flex-row py-5">
            ...
            <div className="absolute bottom-80 lg:-bottom-32 h-96 lg:right-0 px-5">
                <div className="w-full h-full lg:w-4/6 flex justify-end relative overflow-x-scroll">
                    <div className="relative img-gradient">
                        <div className="w-32 lg:w-64 h-full z-0 p-1">
