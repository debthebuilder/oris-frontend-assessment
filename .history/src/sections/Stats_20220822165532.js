        ...
        <section className="w-full md:w-5/6 mx-auto">
            ...
            <div className="flex flex-row items-start mt-16">
                <div className="w-2/6">
                    ...
                    <p className="mt-3 mb-5 leading-7">Plug into an end-to-end sales ecosystem powered by people, data and trust. Optimize your salesforce across all regions.</p>
