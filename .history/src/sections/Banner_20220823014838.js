...
const Banner = () => {
    return(
        <section className="bg-gray-light pb-10 relative overflowx-hidden">
            <Navbar />
            <Container>
                <div className="py-20">
                    <h1 className="font-normal text-black text-center md:leading-loose text-xl md:text-4xl lg:leading-relaxed lg:text-5xl ">Join a community of <Logo size={"w-8 md:w-12 lg:w-20"} /> <span className="font-semibold">salespeople helping brands reach their customers</span>  quickly, efficiently and reliably.</h1>
                </div>
                <div className="flex flex-col-reverse lg:flex-row py-5">
                    ...
                    <div className="w-full mb-20 lg:w-4/6 flex justify-end">
                    
                        <div className="w-72 h-96 relative">
                            <div className="absolute w-full h-full top-0 left-0 z-20 p-1">
