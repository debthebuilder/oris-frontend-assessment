        ...
        <section className="bg-black py-12">
            <Container>
                <div className="flex flex-row items-center">
                    ...
                    <div className="ml-10 w-">
                        <blockquote className="text-white text-4xl leading-10">Oris has completely transformed<br/> our recruitment process by fast-tracking and automating everything.</blockquote>
                        <div>
                            <div>
