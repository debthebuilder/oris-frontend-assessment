...
const Banner = () => {
    return(
        <section className="bg-gray-light h-auto pb-10 relative">
            ...
            <Container>
                <div className="py-20">
                    <h1 className="font-normal text-black text-center leading-10 md:leading-loose text-2xl md:text-3xl lg:leading-relaxed lg:text-5xl ">Join a community of <Logo size={"w-8 md:w-12 lg:w-20"} /> <span className="font-semibold">salespeople helping brands reach their customers</span>  quickly, efficiently and reliably.</h1>
                </div>
