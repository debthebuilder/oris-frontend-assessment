        ...
        <section>
            <Container>
                ...
                <div className="bg-black py-12 px-10 flex flex-col items-center">
                    <h3 className="text-white text-4xl text-center py-5 leading-normal">Join a community of <br/>like-minded sales specialists.</h3>
                    <div className="bg-blue text-black rounded py-3 px-7 font-medium mt-10 mb-16">Get started in 3 easy steps</div>
                    <div className="grid grid-cols-1 md:grid-colslg:grid-cols-3 gap-4">
