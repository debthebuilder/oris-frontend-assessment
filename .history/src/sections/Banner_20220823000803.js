...
const Banner = () => {
    return(
        <section className="bg-gray-light pb-10">
            ...
            <Container>
                <div className="py-20">
                    <h1 className="font-normal text-black text-center text-xl md:text-4xl lg:leading-relaxed lg:text-5xl ">Join a community of <Logo size={"w-8 md:w-12 lg:w-24"} /> <span className="font-semibold">salespeople helping brands reach their customers</span>  quickly, efficiently and reliably.</h1>
                </div>
