...
const Navbar = (props) => {
    ...
    return(
        <header className="py-3 px-5 relative">
            ...
            <div className={`${isOpen ? "block" :"hidden"} absolute left-0 flex flex-col items-start bg-gray-light w-full bg-opacity-90 py-2 px-5 border-b border-b-2 border-red`}>
