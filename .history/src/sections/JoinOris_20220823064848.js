...
import Profile from "../assets/svg/profile.webp";
...
const JoinOris = () => {
    return(
        <section>
            <Container>
                <h2 className="text-3xl md:text-4xl mb-5 lg:text-5xl font-light text-right">Launch <Logo size={"w-10  md:w-14 lg:w-20"} /> your sales career</h2>
