            ...
            <Container>
                <div className="flex flex-row items-center">
                    ...
                    <div className="ml-10 w-4/6">
                        <blockquote className="text-white text-4xl leading-">Oris has completely transformed our recruitment process by fast-tracking and automating everything.</blockquote>
                        <div>
                            <div>
