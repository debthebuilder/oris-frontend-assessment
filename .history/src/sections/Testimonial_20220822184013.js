        ...
        <section className="bg-black py-12">
            <Container>
                <div className="flex flex-row items-center">
                    ...
                    <div>
                        <blockquote className="text-white text-5xl">Oris has completely transformed our recruitment process by fast-tracking and automating everything.</blockquote>
                        <div>
                            <div>
