            ...
            <Container>
                ...
                <div className="flex md:mt-96 flex-row py-5">
                    <div className="w-full lg:w-2/6">
                        <p className="text-base text-center md:tezt-left lg:text-left leading-loose font-normal text-black mb-7">Plug into an end-to-end sales ecosystem powered by people, data and trust. Optimize your salesforce across all regions.</p>
