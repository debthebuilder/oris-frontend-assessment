        ...
        <footer className="bg-gray-light">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center py-24">
                <div className="w-full lg:w-1/2">
                    ...
                    <p className="leading-7 mt-5 mb-7 lgw-4/6 text-sm">Oris offers a large network of qualified sales professionals with deep product expertise and ready-to-use business solutions. </p>
