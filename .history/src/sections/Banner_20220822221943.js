...
const Banner = () => {
    return(
        <section className="bg-gray-light pb-10">
            ...
            <Container>
                <div className="py-10">
                    <h1 className="font-normal text-black text-center text-2xl md:text-4xl leading-loose lg:text-5xl ">Join a community of <Logo size={""} /> <span className="font-semibold">salespeople helping brands reach their customers</span>  quickly, efficiently and reliably.</h1>
                </div>
