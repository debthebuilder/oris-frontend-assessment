...
const JoinOris = () => {
    return(
        <section>
            <Container>
                <h2 className="text-5xl font-light text-right">Launch<Logo size={"w-20"} /> your sales career</h2>
                ...
                <div className="bg-black py-12 px-10 flex flex-col items-center">
                    <h3 className="text-white text-2xl md:text-3xl lg:text-4xl text-center py-5 leading-relaxed">Join a community of <br/>like-minded sales specialists.</h3>
                    <div className="bg-blue text-black rounded py-3 px-7 font-medium mt-7 mb-12 lg:mt-10 lg:mb-16">Get started in 3 easy steps</div>
