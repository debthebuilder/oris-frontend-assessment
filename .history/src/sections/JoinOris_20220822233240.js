        ...
        <section>
            <Container>
                ...
                <div className="flex flex-col lg:flex-row lg:items-center relative">
                    ...
                    <OwlCarousel className='relative' loop margin={10} items={2}  nav={true}>
                    <div className="owl-nav">
        <div className="owl-prev absolute -left-20">prev</div>
        <div className="owl-next absolute -right-20">next</div>
    </div>
                        <div className='item'>
