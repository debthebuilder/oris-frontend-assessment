        ...
        <section>
            <Container>
                ...
                <div className="bg-black py-12 px-10 flex flex-col items-center">
                    ...
                    <div className="bg-blue text-black rounded py-1 md:py-2 lg:py-3 px-7 font-medium mt-7 mb-12 lg:mt-10 lg:mb-16 text-center">Get started in 3 easy steps</div>
