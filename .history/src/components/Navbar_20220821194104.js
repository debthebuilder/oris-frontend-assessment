        ...
        <header className="py-3 px-5">
            <nav className="flex flex-row items-center justify-between w-full">
                ...
                <div className="tracking-wide leading-4 text-sm ">
                    <Link to={'/'} className={`uppercase ${props.home ? "text-red" : "text-black"} mx-5`}>Home</Link>
                    <Link to={'/about'} className={`uppercase ${props.about ? "text-red" : "text-black"} mx-5 `}>about us</Link>
