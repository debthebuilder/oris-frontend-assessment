    ...
    return(
        <section className="bg-gray-light pb-10">
            ...
            <div className="w-full md:w-5/6 mx-auto">
                ...
                <div>
                    <div className="w-2/6">
                        <p className="text-base leading-loose font-normal text-black mb-7">Plug into an end-to-end sales ecosystem powered by people, data and trust.<br Optimize your salesforce across all regions.</p>
