        ...
        <section>
            <Container>
                ...
                <div className="w-full flex flex-col items-start lg:w-2/6">
                    ...
                    <p className="mt-3 mb-5 leading-7 text-lg leading-10">Elevate your sales experience working for Top Brands. We bring you the jobs, the training and the resources, so you can excel at what you do best. Sales.
                    </p>
