        ...
        <header>
            <nav className="flex flex-row items-center justify-between">
                ...
                <div className="tracking-wide leading-4 text-sm ">
                    ...
                    <Link to={'/about'} className={`text-uppercase ${props.about ? "text-red" : "text-black"} mx-2 capitalize`}>about us</Link>
                    <Link to={'/about'} className={`text-uppercase ${props.about ? "text-red" : "text-black"} mx-`}>about us</Link>
                </div>
                <div>
                    <Link to={'/login'}>
