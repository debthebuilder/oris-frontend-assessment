            ...
            <Container>
                ...
                <div className="flex flex-col lg:flex-row lg:items-center relative">
                    ...
                    <OwlCarousel className='owl-theme' loop margin={10} items={1}  nav={true}>
                        <div class='item'><Card title="Learn More" body={"Access a pool of training resources to elevate your sales knowledge and competence. Track your progress and development with standardized tests. Test your skills in the field selling leading brands and products."} /></div>
