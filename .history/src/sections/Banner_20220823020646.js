...
const Banner = () => {
    return(
        <section className="bg-gray-light h-auto pb-10 ">
            <Navbar />
            <Container>
                <div className="py-20">
            ...
            <div className="w-full h-full absolute -right-32 -bottom-56 lg:w-4/6 flex justify-end">
                    ...
                    <div className="w-full h-96 relative overflow-x-hidden">
