        ...
        <section>
            <Container>
                ...
                <div className="flex flex-row items-center">
                    ...
                    <Card title="Earn More" body={"Access a pool of training resources to elevate your sales knowledge and competence. Track your progress and development with standardized tests. Test your skills in the field selling leading brands and products."} />
                </div>
            </Container>
        </section>
    )
