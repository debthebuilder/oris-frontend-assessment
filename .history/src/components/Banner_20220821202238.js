...
const Banner = () => {
    return(
        <div className="w-full md:w-5/6 mx-auto">
            ...
            <div>
                <div className="w-1/5">
                    <p className="text-xl font-normal text-black">Plug into an end-to-end sales ecosystem powered by people, data and trust. Optimize your salesforce across all regions.</p>
