                    ...
                    <Container>
                        <div className="flex flex-col lg:flex-row lg:items-start relative">
                            ...
                            <div className="flex justify-center">
                                <div className="border border-4 border-white w-24 md:w-32 md:h-32 lg:w-64 lg:h-64 rounded-full">
                                    <img src={Naomi} alt={"Naomi Doe"} className={"w-full h-full rounded-full"} />
                                </div>
                            </div>
                        
                            <div className="ml-10 w-full lg:w-4/6">
                                <blockquote className="text-white text-center lg:text-left lg:text-4xl leading-normal">Oris has completely transformed our recruitment process by fast-tracking and automating everything.</blockquote>
