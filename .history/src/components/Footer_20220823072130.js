...
import Avatar3 from "../assets/images/marcus-santos.webp";
import Avatar2 from "../assets/images/portrait-expressive-african-american-woman.webp";
import Avatar from "../assets/images/pexels-cottonbro.webp";
...
const Footer = () => {
    return(
        <footer className="bg-gray-light">
            <Container>
            <div className="flex flex-col lg:flex-row lg:items-center py-12 lg:py-24">
                <div className="w-full lg:w-1/2">
                    <div className="font-semibold text-3xl"><Logo size={"w-8 md:w-12"} />oris</div>
                    <p className="leading-7 mt-5 mb-7 lg:w-4/6 text-sm">Oris offers a large network of qualified sales professionals with deep product expertise and ready-to-use business solutions. </p>
                ...
                <div className="w-full lg:w-1/2 grid grid-cols-2 md:grid-cols-3 gap-5 mt-16 lg:mt-0">
                    ...
                    <div className="flex flex-col">
                        <MenuItem label={"LinkedIn"} link={"/"} />
                        <MenuItem label={"Twitter"} link={"#"} />
                        <MenuItem label={"Instagram"} link={"#"} />
                        <MenuItem label={"Facebook"} link={"#"} />
                    </div>
                </div>
            </div>
