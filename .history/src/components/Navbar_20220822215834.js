        ...
        <header className="py-3 px-5">
            ...
            <div className="flex flex-col items-start ">
                ...
                <div className="flex flex-col items-start tracking-wide leading-4 text-sm ">
                    <Link to={'/'} className={`uppercase ${props.home ? "text-red" : "text-black"} ml-2 mb-4`}>Home</Link>
                    <Link to={'/about'} className={`uppercase ${props.about ? "text-red" : "text-black"} ml-2 mb-4 `}>about us</Link>
                    <Link to={'/jobs'} className={`uppercase ${props.about ? "text-red" : "text-black"} ml-2 mb-4`}>jobs</Link>
                    <Link to={'/faq'} className={`uppercase ${props.about ? "text-red" : "text-black"} ml-2 mb-4 `}>faq</Link>
                    <Link to={'/contact'} className={`uppercase ${props.about ? "text-red" : "text-black"} ml-2 mb-4`}>contact us</Link>
                </div>
            </div>
        </header>
    )
