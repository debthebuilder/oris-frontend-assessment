        ...
        <section>
            <Container>
                ...
                <div className="bg-black py-12 lg:px-10 flex flex-col items-center">
                    <h3 className="text-white text-2xl md:text-3xl lg:text-4xl text-center py-5 leading- lg:w-4/6 lg:mx-auto">Join a community of like-minded sales specialists.</h3>
