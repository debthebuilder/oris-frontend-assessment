...
const Banner = () => {
    return(
        <div className="w-full md:w-5/6 mx-auto">
            ...
            <div>
                <div className="w-1/5">
                    <p className="text-base leading-loose font-normal text-black mb-">Plug into an end-to-end sales ecosystem powered by people, data and trust. Optimize your salesforce across all regions.</p>
