    ...
    return(
        <section>
            <Container>
                ...
                <Spacer height={"h-24"} />
                <div className="bg-black py-12 lg:px-10 flex flex-col items-center">
                    <h3 className="text-white text-2xl md:text-3xl lg:text-4xl text-center py-5 leading-normal lg:leading-relaxed lg:w-4/6 lg:mx-auto">Join a community of like-minded sales specialists.</h3>
                ...
                <div className="flex flex-col lg:flex-row lg:items-center relative">
                    ...
                    <OwlCarousel 
                        ...
                        {/* <div className="absolute -left-20"> <span className="flex items-center owl-prev justify-center bg-gray-light w-12 h-12 rounded-full"><i className="fa-solid fa-chevron-left"></i></span></div>
                            <div className=" absolute -right-24"><span className="flex items-center owl-next justify-center bg-gray-light w-12 h-12 rounded-full"><i className="fa-solid fa-chevron-right"></i></span></div> */}
                    </OwlCarousel>
