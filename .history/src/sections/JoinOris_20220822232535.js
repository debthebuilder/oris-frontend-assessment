    ...
    return(
        <section>
            <Container>
                ...
                <Spacer height={"h-24"} />
                <OwlCarousel className='owl-theme' loop margin={10} items={2}  nav={true}>
                <div class='item'>
                    ...
                    <div class='item'>
                    <Card title="Earn More" body={"With compensation structures tied to performance, achieving more means earning more. Tap into unlimited earning options as you attain sales targets. Tie your earnings to the fortunes 
