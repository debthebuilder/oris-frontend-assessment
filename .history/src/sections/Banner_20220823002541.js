            ...
            <Container>
                ...
                <div className="flex flex-col-reverse lg:flex-row py-5">
                    ...
                    <div className="grid grid-cols-3 ">
                        <div className="" >
                            <div className="bg-gradient-to-b from-gray-light to-black flex justify-center">
                            <img src={Oluchi} alt="Oluchi Chibuzor | Mid-level Sales Rep" className="w-1/2" />
                            </div>
                            <div className="bg-gradient-to-b from-gray-light to-black flex justify-center"></div>
