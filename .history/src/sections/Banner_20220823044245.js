...
const Banner = () => {
    return(
        <section className="bg-gray-light h-auto pb-10 relative">
            ...
            <Container>
                <div className="py-20">
                    <h1 className="font-normal text-black lg:text-center leading-10 md:leading-loose text-2xl md:text-3xl lg:leading-relaxed lg:text-5xl ">Join a community of <Logo size={"w-8 md:w-12 lg:w-20"} /> <span className="font-semibold">salespeople helping brands reach their customers</span>  quickly, efficiently and reliably.</h1>
                </div>
                <div className="flex mt-96 lg:mt-0 flex-row py-5">
                    <div className="w-full lg:w-2/6">
                        <p className="text-base text-center md:text-left lg:text-left leading-loose font-normal text-black mb-7">Plug into an end-to-end sales ecosystem powered by people, data and trust. Optimize your salesforce across all regions.</p>
            ...
            <div className="absolute max-w-min bottom-80 md:bottom-64 md:-left-10 lg:-bottom-32 h-96 lg:left-80 px-5">
