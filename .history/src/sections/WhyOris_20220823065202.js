...
import image from "../assets/images/pexels-ono-kosuki.webp";
...
const WhyOris = () => {
    return(
        <section className="overflow-x-hidden">
            <div className="bg-black pt-24 pb-80  relative">
                <Container>
                    ...
                    <div className="mb-10">
                        <h2 className="text-white font-medium text-3xl md:text-4xl lg:text-5xl mb-5">Maximize Sales.<br/>Minimize Leakage. <br/>Optimize Control</h2>
                        <Button label={'join oris today'} filled={true} icon={true} />
                    </div>
                    <div className="absolute left-0  md:left-12 lg:left-24 lg:-bottom-44 w-full">
                        <div className="flex flex-col lg:flex-row lg:items-end">
                            <div>
                                <img src={image} alt={"Man seated using a macbook."} />
                            </div>
                            <div className="bg-yellow w-full lg:w-80 divide-y divide-dashed divide-black divide-opacity-50 py-12">
                                <div className=" flex flex-col text-black pl-10 px-5 py-5">
                                    ...
                                    <span className="text-base md:text-lg lg:text-xl font-normal">Revenue growth</span>
                                </div>
                                <div className=" flex flex-col text-black pl-10 px-5 py-10 lg:py-5">
                                    ...
                                    <span className="text-base md:text-lg lg:text-xl font-normal">Reduction in lost sales and theft</span>
                                </div>
                                <div className=" flex flex-col text-black pl-10 px-5 py-5">
                                    <span className="text-2xl md:text-4xl lg:text-7xl font-medium">10x</span>
                                    <span className="text-base md:text-lg lg:text-xl font-normal">Reduction in staff turnover</span>
                                </div>
        ...
        <Spacer height={"h-12 md:h-44 lg:h-0"} />
            <Container>
            <div className="mt-80 md:mt-96 lg:mt-56">
