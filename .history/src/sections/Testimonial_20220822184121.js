        ...
        <section className="bg-black py-12">
            <Container>
                <div className="flex flex-row items-center">
                    ...
                    <div className="ml-10">
                        <blockquote className="text-white text-4xl leading-relaxed">Oris has completely transformed our recruitment process by fast-tracking and automating everything.</blockquote>
                        <div>
                            <div>
