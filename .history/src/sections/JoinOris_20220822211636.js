...
const JoinOris = () => {
    return(
        <section>
            <Container>
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-light text-center lg:text-right">Launch<Logo size={"w-20"} /> your sales career</h2>
                <div className="flex flex-col lg:flex-row lg:items-start">
               
                <div>
                    <img src={Profile} alt="" />
                </div>
                <div className="w-full flex flex-col items-center lg:w-2/6">
