    ...
    return(
        <footer className="bg-gray-light">
            ...
            <div className="flex flex-row items-center py-10">
                <div className="w-1/2">
                    <div><Logo />oris</div>
                    <p className="leading-7 mt-5 mb-7 ">Oris offers a large network of qualified sales professionals with deep product expertise and ready-to-use business solutions. </p>
