                ...
                <div class='item'>
                    <Container>
                        <div className="flex flex-col lg:flex-row lg:items-start relative">
                            ...
                            <div className="lg:ml-10 w-full lg:w-4/6">
                                <blockquote className="text-white text-center lg:text-left text-xl md:text-2xl lg:text-4xl leading-normal py-5 lg:py-5">Oris has completely transformed our recruitment process by fast-tracking and automating everything.</blockquote>
                                <div className="flex flex-row items-center justify-between">
                                    <div className="flex flex-col">
                                        <span className="text-red">Naomi Doe</span>
                                        <span className="text-white text-xs md:text">Recruitment Lead, GB Foods</span>
                                    </div>
                                    <div>
