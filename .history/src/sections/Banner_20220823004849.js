            ...
            <Container>
                ...
                <div className="flex flex-col-reverse lg:flex-row py-5">
                    ...
                    <div className="grid grid-cols-3 ">
                        <div className="" >
                            <div className="w-full  relative bg-gradient-to-b from-gray-light to-black flex justify-center">
                                <div className="w-56 h-96 bg-gradient-to-b from-gray-light to-black flex justify-center"></div>
                                ...
                                <div className="absolute top-64 w-full z-50 bg-transparent">
                                <div className="w-full bg-gradient-to-b from-gray-light to-black text-white px-5 py-3 flex flex-row items-center justify-between">
