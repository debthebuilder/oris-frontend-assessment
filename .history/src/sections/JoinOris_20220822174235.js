        ...
        <section>
            ...
            <div className="flex flex-row items-start">
                ...
                <div className="w-2/6">
                    ...
                    <p className="mt-3 mb-5 leading-7">Elevate your sales experience working for Top Brands. We bring you the jobs, the training and the resources, so you can excel at what you do best. Sales. <b
