    ...
    return(
        <section className="bg-gray-light h-auto pb-10 relative">
            ...
            <Container>
                ...
                <div className="flex mt-64 md:mt-96 lg:mt-0 flex-row py-5">
            ...
            <div className="absolute w-full bottom-64 md:bottom-64 md:-left-10 lg:-bottom-32 h-96 lg:left-80 px-5">
