        ...
        <section className="bg-black py-12">
            <Container>
                ...
                <div className="absolute -left-20">
                        <span className="flex items-center justify-center shadow-xl bg-gray-light bg-opacity-10 w-12 h-12 rounded-full"><i className="fa-solid fa-chevron-left"></i></span>
                    </div>
                    <div>
