        ...
        <Container>
            ...
            <div className="flex flex-col-reverse lg:flex-row items-start">
                <div className="w-full mt-5 lg:w-2/6">
                    ...
                    <p className="mt-5 mb-7 leading-7 text-lg leading-10d">Plug into an end-to-end sales ecosystem powered by people, <br/>data and trust. Optimize your salesforce across all regions.</p>
