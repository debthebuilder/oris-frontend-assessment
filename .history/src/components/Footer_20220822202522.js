    ...
    return(
        <footer className="bg-gray-light">
            ...
            <div className="flex flex-row items-center py-10">
                <div className="w-1/2">
                    <div><Logo />oris</div>
                    <p className="leading-7 mt-5 mb-7 w-4/6 t">Oris offers a large network of qualified sales professionals with deep product expertise and ready-to-use business solutions. </p>
                    <div className="flex flex-row items-center">
                        <div className="relative flex flex-row items-center mr-28 pl-1">
                            <div className="absolute left-14 w-14 h-14 border rounded-full border-4 border-white z-50">
                                <img src={Avatar} alt="" className="w-full h-full rounded-full"/>
                            </div>
                            <div className="absolute left-5 z-40 w-14 h-14 border rounded-full border-4 border-white">
                                <img src={Avatar2} alt="" className="w-full h-full rounded-full"/>
                            </div>
                            <div className="absolute -left-4 w-14 h-14 border rounded-full border-4 border-white">
