...
const Banner = () => {
    return(
        <section className="bg-gray-light h-auto pb-10 relative">
            ...
            <Container>
                ...
                <div className="flex md:mt-96 flex-row py-5">
                    <div className="w-full lg:w-2/6">
                        ...
                        <div className="flex items-center md justify-center md:justify-start">
            ...
            <div className="absolute w-full bottom-80 md:bottom-64 md:-left-10 lg:-bottom-32 h-96 lg:left-80 px-5">
