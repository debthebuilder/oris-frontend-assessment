...
const Banner = () => {
    return(
        <section className="bg-gray-light h-auto pb-10 relative">
            ...
            <div className="absolute bottom-72 md:bottom-64 left-0 md:left-44 lg:-bottom-32 h-96 lg:left-56 lg:-right-96 px-5">
                
                <div className="w-full h-full lg:w-4/6 flex justify-end relative overflow-x-hidden">
                    <div className="relative img-gradient w-auto">
                        <div className="w-64 md:w-56 h-full z-0">
                    ...
                    <div className="hidden sm:inline relative img-gradient">
