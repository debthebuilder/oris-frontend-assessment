        ...
        <header className="py-3 px-5">
            <nav className="flex flex-row items-center justify-between w-full">
                ...
                <div className="hidden lg:block tracking-wide leading-4 text-sm ">
                    ...
                    <Link to={'#'} className={`uppercase ${props.about ? "text-red" : "text-black"} mx-4 `}>about us</Link>
                    <Link to={'#'} className={`uppercase ${props.about ? "text-red" : "text-black"} mx-4`}>jobs</Link>
                    <Link to={'#'} className={`uppercase ${props.about ? "text-red" : "text-black"} mx-4 `}>faq</Link>
                    <Link to={'#'} className={`uppercase ${props.about ? "text-red" : "text-black"} mx-4`}>contact us</Link>
                </div>
