            ...
            <Container>
                ...
                <div className="flex flex-col lg:flex-row lg:items-center relative">
                    ...
                    <OwlCarousel 
                        ...
                        navClass={"w-full flex justify-between"}>
                        ...
                        <div className="absolute -left-20"> <span className="flex items-center owl-prev justify-center bg-gray-light w-12 h-12 rounded-full"><i className="fa-solid fa-chevron-left"></i></span></div>
                            <div className=" absolute -right-20"><span className="flex items-center owl-next justify-center bg-gray-light w-12 h-12 rounded-full"><i className="fa-solid fa-chevron-right"></i></span></div>
                    </OwlCarousel>
