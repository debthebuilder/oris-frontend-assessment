...
const Stats = () => {
    return(
        <section className="w-full md:w-5/6 mx-auto">
            <h2 className="text-3xl md:text-4xl  lg:text-5xl font-light">Early adopters <Logo size={"w-20"} /> have reported...</h2>
            <div className="flex flex-col-reverse lg:flex-row items-start">
                <div className="w-full lg:w-2/6">
                    <span className="block font-medium mt-24"><Logo size="w-3 lg:w-7" /> FMCGs</span>
