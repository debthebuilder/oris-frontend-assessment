        ...
        <section>
            ...
            <div className="w-full md:w-5/6 mx-auto mt-80">
                ...
                <div className="flex flex-row">
                    <div className="bg-gray-light text-black py-5 px-3 mb-5 w-64">
                        <span className="block font-medium text-2xl py-3 ">Recruit</span>
                        <p className="font-normal text-base leading-7">Hire, verify and test competent, motivated salespeople that hit the ground running.</p>
                    </div>
                    <div className="bg-gray-light text-black py-5 px-3 mb-5">
                        <span className="block font-medium text-2xl py-3 ">Recruit</span>
                        <p className="font-normal">Hire, verify and test competent, motivated salespeople that hit the ground running.</p>
                    </div>
                    <div className="bg-gray-light text-black py-5 px-3 mb-5">
                        <span className="block font-medium text-2xl py-3 ">Recruit</span>
                        <p className="font-normal">Hire, verify and test competent, motivated salespeople that hit the ground running.</p>
