                ...
                <div className="w-1/2">
                    ...
                    <div className="flex flex-row items-center">
                        <div className="relative flex flex-row items-center">
                            ...
                            <div className="absolute left-24 w-14 h-14 border rounded-full border-4 border-white">
                                <img src={Avatar} alt="" className="w-full h-full rounded-full"/>
                            </div>
                            <div className="absolute left-12 w-14 h-14 border rounded-full border-4 border-white">
                                <img src={Avatar} alt="" className="w-full h-full rounded-full"/>
                            </div>
                        </div>
