...
const JoinOris = () => {
    return(
        <section>
            <Container>
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-light text-right">Launch<Logo size={"w-20"} /> your sales career</h2>
                <div className="flex flex-col lg:flex-row lg:items-start">
               
                <div>
                    <img src={Profile} alt="" />
                </div>
                <div className="w-full flex flex-col items-end lg:w-2/6">
                    <span className="block font-medium mt-8 md:mt-24 lg:mt-36"><Logo size="w-7" /> Sales Reps</span>
                    <p className="mt-3 mb-5 leading-7 text-center lg:text-left">Elevate your sales experience working for Top Brands. We bring you the jobs, the training and the resources, so you can excel at what you do best. Sales.
                    </p>
                    <p className="font-medium mb-5 text-right lg:text-left">Learn More.  Earn More.  <br/>
                    Share More.</p>
                ...
                <div className="flex flex-row items-center relative">
                    ...
                    <div className="absolute -right-20">
                        <span className="flex items-center justify-center bg-gray-light w-12 h-12 rounded-full"><i className="fa-solid fa-chevron-right"></i></span>
                    </div>
                </div>
                <Spacer height={"h-24"} />
